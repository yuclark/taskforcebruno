          ...
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3">
            ...
            <div className="flex items-center gap-2 flex-wrap">
              ...
              {volunteerApplications.length > 0 && (
                <button
                  type="button"
                  onClick={handlePurgeAllVolunteers}
                  className="px-3 py-1.5 bg-rose-50 hover:bg-rose-100 border border-rose-200 text-rose-700 font-mono text-[10px] font-bold rounded-xl transition-all flex items-center gap-1 shadow-xs"
                >
                  <svg className="w-3.5 h-3.5" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
